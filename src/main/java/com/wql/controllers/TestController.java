...
public class TestController {
    ...
    @RequestMapping(value = "api/v1.0/testAPI5", method = RequestMethod.GET)
    public Object queryFive(@RequestParam(value = "data",required = true)String dataString){
        String decryptData = AESHelper.decryptString(dataString);
        System.out.println("解密结果："+decryptData);
        return decryptData;
    }
